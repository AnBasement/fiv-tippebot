...
class FantasyReminders(commands.Cog):
    ...
    Attributes:
        ...
        last_waiver_week (Optional[int]): Siste uke det ble sendt tirsdagspåminnelse
    """
    ...
    async def reminder_scheduler(self) -> None:
        """Scheduler som sender ukentlig påminnelse om waivers tirsdager kl. 18:00.
        ...
        Sørger for at meldingen kun sendes én gang per uke ved å sjekke `last_waiver_week`.
        ...
        Attributes:
            ...
            weekday (int): Ukedag for nåværende tidspunkt (0=mandag, 1=tirsdag, …)
            week_num (int): ISO-ukenummer for nåværende uke
            reminder_time (datetime): Tidspunkt meldingen skal sendes
            tomorrow (datetime): Dagen etter reminder_time, for å unngå dobbelposting
